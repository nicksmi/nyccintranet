...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  <head>
    <?php hide($print['field_supporting_documnets']) ?>
...
<?php if (!empty($message)): ?>
    ...
    <h3 class="print-h3 no-margin-bottom">Policy</h3>
    ...
    <div class="print-links">
      <?php 
        ...
        $address_url=$_SERVER['HTTP_HOST'];
        print $address_url;

        if (false !== strpos($address_url,'nyccintranet.northyorks.gov.uk')) {
          $urls = theme('print_url_list');
          $updated_urls = str_replace('/nyccintranet/', '/nyccintranet.northyorks.gov.uk/', $urls);
          print $updated_urls;

        } 
        elseif(false !== strpos($address_url,'intranet-dev')) {
          $urls = theme('print_url_list');
          $updated_urls = str_replace('/intranet-dev/', '/nyccintranet.northyorks.gov.uk/', $urls);
          print $updated_urls;
